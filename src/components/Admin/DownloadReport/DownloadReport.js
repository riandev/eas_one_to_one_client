...
const DownloadReport = () => {
  ...
  const handleReport = () => {
    fetch(`http://192.168.10.11:5010/getBRReport/${reportDate}`)
      .then((res) => res.json())
      .then((data) => setBRReport(data));
    fetch(`http://192.168.10.11:5010/getTerritoryReport/${reportDate}`)
      .then((res) => res.json())
      .then((data) => setTerritoyReport(data));
    fetch(`http://192.168.10.11:5010/getAreaReport/${reportDate}`)
      .then((res) => res.json())
      .then((data) => setAreaReport(data));
    fetch(`http://192.168.10.11:5010/getRegionReport/${reportDate}`)
      .then((res) => res.json())
